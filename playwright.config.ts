...
export default defineConfig({
  ...
  use: { baseURL: 'http://127.0.0.1:4178', headless: true, launchOptions: process.env.LIVEMIXER_BROWSER_EXECUTABLE ? { executablePath: process.env.LIVEMIXER_BROWSER_EXECUTABLE } : {} },
  workers: 1,
